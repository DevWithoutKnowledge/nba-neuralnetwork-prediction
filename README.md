...
It is important to know that datasets are not balanced because of the way i scrapped the data. 57.62% of games are won by home teams and I labaled all home team wins as 1. I could have fixed that but I was wondering if this helps my networks with phenomenon called home court advantage.
# Neural networks
